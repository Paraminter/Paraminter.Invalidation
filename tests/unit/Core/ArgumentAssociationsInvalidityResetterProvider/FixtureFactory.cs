...
internal static class FixtureFactory
{
    public static IFixture Create()
    {
        ...
        var sut = new ArgumentAssociationsInvalidityResetterProvider(invalidityProviderMock.Object);
    ...
    private sealed class Fixture
        : IFixture
    {
        private readonly IQueryHandler<IGetArgumentAssociationsInvalidityResetterQuery, IArgumentAssociationsInvalidityResetter> Sut;
        ...
        public Fixture(
            IQueryHandler<IGetArgumentAssociationsInvalidityResetterQuery, IArgumentAssociationsInvalidityResetter> sut,
        ...
        IQueryHandler<IGetArgumentAssociationsInvalidityResetterQuery, IArgumentAssociationsInvalidityResetter> IFixture.Sut => Sut;
